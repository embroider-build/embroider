...
// @ts-expect-error We have extra metadata on our resolveId return objects
const resolverBuilder: UnpluginFactory<undefined> = () => {
  ...
  return {
    ...
    async resolveId(source, importer, options) {
      // @ts-expect-error - do we have a this?
...
export const resolver = /* #__PURE__ */ createUnplugin<undefined>(resolverBuilder);
