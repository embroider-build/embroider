...
export default class V1Addon implements V1Package {
  constructor(protected addonInstance: any, private packageCache: PackageCache, protected addonOptions: OptionsWithDefaults) {
...
export interface V1AddonConstructor {
  new(addonInstance: any, packageCache: PackageCache, options: OptionsWithDefaults): V1Addon;
}
