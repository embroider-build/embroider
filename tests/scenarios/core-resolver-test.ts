    ...
    Qmodule(scenario.name, function (hooks) {
      ...
      Qmodule('engine-relative resolving', function () {
        ...
        test(`resolves app fastboot-js`, async function () {
          ...
          await configure({
            fastbootFiles: { './hello-world.js': { localFilename: './fastboot/hello-world.js', shadowsApp: false } },
          });
        ...
        test(`file exists in both app-js and fastboot-js for app files`, async function () {
          givenFiles({
            'fastboot/hello-world.js': `
              export function hello() { return 'fastboot'; }
              export class Bonjour {}
          ...
          await configure({
            fastbootFiles: { './hello-world.js': { localFilename: './fastboot/hello-world.js', shadowsApp: true } },
          });
