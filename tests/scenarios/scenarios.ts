...
async function lts_5_4(project: Project) {
  ...
  project.linkDevDependency('ember-data', { baseDir: __dirname, resolveName: 'ember-data-5.4' });
}
...
async function lts_5_8(project: Project) {
  ...
  project.linkDevDependency('ember-data', { baseDir: __dirname, resolveName: 'ember-data-5.8' });
}
