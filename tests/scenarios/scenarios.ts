...
/**
 * We need to test v2 addons' sourcemaps
 * - as generated from the v2 addon
 * - as consumed within a v2 app
 *
 * This scenario contains all the files we want to assure
 * sourcemaps work for.
 */
export function v2AddonForSourceMapTesting(): Project {
